...
public class EBIAddressSelectionDialog  {
    ...
    private List<Companyaddress> caddressList = null;
    private Set<Companycontactaddress> coaddressList = null;
    private int selRow = -1;
    private EBICRMModule ebiModule = null;

    
    public EBIAddressSelectionDialog(EBICRMModule module, List<Companyaddress> clist, Set<Companycontactaddress> colist) {

...
public class MyTableModelReportSetting extends AbstractTableModel {
					...
					public String[] columnNames = {
				            ...
				            EBIPGFactory.getLANG("EBI_LANG_SHOW_AS_PDF"),
				            EBIPGFactory.getLANG("EBI_LANG_SHOW_NORMAL")
				            };
					

					
					public Object[][] data = {{Boolean.valueOf(false), EBIPGFactory.getLANG("EBI_LANG_PLEASE_SELECT"),"","","","",""}};

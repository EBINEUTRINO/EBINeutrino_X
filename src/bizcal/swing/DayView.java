...
//		Date end = DateUtil.getDiffDay(start, +1);
    ...
    private void createColumns() throws Exception {
        ...
        for (int it = 0; it < cols; it++) {
            ...
            bizcal.common.BCalendar cal = (bizcal.common.BCalendar) getSelectedCalendars()
                    .get(iCal);
            ...
            try {
                ...
                for (int i = 0; i < eventColList.size(); i++) {
                    ...
                    if (i > 0) {
                        ...
                        // add the line position to the mainComponentBean
                    ...
                    // ======================================================
                    // eventColList contains a mainComponentBean of ArrayLists that holds the
                    // events per day

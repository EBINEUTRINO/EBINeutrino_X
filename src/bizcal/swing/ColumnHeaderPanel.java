...
public class ColumnHeaderPanel {
    //	public static final Color GRADIENT_COLOR = new Color(0, 230, 230);
...
//				GradientArea.LEFT_RIGHT, Color.WHITE, GRADIENT_COLOR);
    ...
    public void refresh()
        ...
        if (dayCount >= 1 || calCount > 1) {
            if (dayCount > 1 && calCount > 1)
                ...
                rowCount = 1;
            DateFormat toolTipFormat = new SimpleDateFormat("EEEE d MMMM", LocaleBroker.getLocale());

//			DateFormat dateFormat = new SimpleDateFormat("EE - d MMMM yyyy", LocaleBroker.getLocale());
//			DateFormat longDateFormat = new SimpleDateFormat("EEEE - d MMMM yyyy", LocaleBroker.getLocale());
//
...
//			}
            ...
            for (int j = 0; j < calCount; j++) {
                ...
                bizcal.common.BCalendar cal = (bizcal.common.BCalendar) model.getSelectedCalendars().get(j);
    ...
    private class CloseListener
        ...
        public void mouseClicked(MouseEvent event) {
            try {
                ...
                EBIExceptionDialog.getInstance(e.getMessage()).Show(EBIMessage.INFO_MESSAGE);
            }
        }
    }

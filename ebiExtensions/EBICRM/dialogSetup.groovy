...
system.gui.getButton("printSetting","CashRegister").actionPerformed={
        ...
        system.gui.getButton("saveValue","printerSetup").actionPerformed={
            ...
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SET_X",system.gui.getSpinner("setXText","printerSetup").getValue().toString())
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SET_Y",system.gui.getSpinner("setYText","printerSetup").getValue().toString())
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SET_WIDTH",system.gui.getSpinner("setWidthText","printerSetup").getValue().toString())
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SET_TEXT_WIDTH",system.gui.getSpinner("setTextWidthText","printerSetup").getValue().toString())
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SET_SPACE_MIN",system.gui.getSpinner("setSpaceMinText","printerSetup").getValue().toString())
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SET_SPACE_MAX",system.gui.getSpinner("setSpaceMaxText","printerSetup").getValue().toString())
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SET_DESCRIPTION_TEXT",system.gui.getTextarea("descriptionText","printerSetup").getText())
            EBIPGFactory.properties.setValue("PRINTER_DIALOG_SHOW_PRINTER_DIALOG",system.gui.getCheckBox("showPrinterDialog","printerSetup").isSelected() ? "1" : "0")

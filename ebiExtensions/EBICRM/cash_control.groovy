...
class CashRegisterPrinter implements Printable {
  ...
  private EBIPGFactory system = null;
  
  public CashRegisterPrinter(EBIPGFactory factory){
    system = factory;   
...
system.gui.getButton("bntSave","CashRegister").actionPerformed={
...
public def updateReturnCash(val, text){
       ...
       String txt =  system.globalVariable.get("valueEditCashR").toString()
       
       system.gui.getEditor("cashView","CashRegister").setText(txt.replaceAll("<table>","<table style='color:#ffffff; font-family: Verdana;'>")+newText)
